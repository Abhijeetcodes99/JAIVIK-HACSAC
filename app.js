...
mongoose.connect("mongodb+srv://javik:civaCxZu3FEvsb2R@cluster0.koxyp.mongodb.net/<dbname>?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false} ).then(()=>{
...
app.post("/schooldetails",isLoggedIn,function(req,res){
    ...
    var amountRequired=req.body.amountRequired;
	...
	var newdetails={name:name,type:type,companyName:companyName,image:image,amountRequired:amountRequired,email:email,contact:contact,author:author,briefInfo:briefInfo,moreInfo:moreInfo}
